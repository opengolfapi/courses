  ...
  return (
    <div>
      ...
      <section className="max-w-[1100px] mx-auto px-6 py-16">
        ...
        <h2 className="font-display text-[28px] sm:text-[36px] font-bold mb-8 max-w-[600px]">Browse by state.</h2>
        <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-7 lg:grid-cols-10 gap-2">
          {[
            ...
            <Link
              ...
              className="px-2 py-1.5 text-sm font-mono rounded text-center hover:bg-white transition-colors"
